"""
Adds proper dead-letter handling for malformed events (bad JSON, missing
required fields, unparseable timestamps), replacing step3's defensive
.get() fallback on warehouse_zone. Malformed events are routed to a
BigQuery error table; well-formed events continue through the same
windowed per-zone count as step3.
"""
